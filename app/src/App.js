...
class  App extends React.Component {
  ...
  submit(evenet,id){
    ...
    if(id===0){
      axios.post("http://44.203.172.191:31111/api/",{
      ...
      axios.put("http://44.203.172.191:31111/api/",{
        id:id,
        name:this.state.name,
        email:this.state.email,
        password:this.state.password
  ...
  delete(id){
    axios.delete("http://44.203.172.191:31111/api/"+id)
    .then(()=>{
      this.componentDidMount();
    })
  }
  edit(id){
    axios.get("http://44.203.172.191:31111/api/"+id)
    .then((res)=>{
      this.setState({
        id:res.data.id,
        name:res.data.name,
